...
pub(crate) const CODEX_PROFILE: CapabilityProfile = CapabilityProfile {
    ...
    daily: Some(ReportProfile {
        ...
        token_categories: TokenCapabilities {
            ...
            reasoning_output: CapabilityState::Supported,
        },
        cost: CostCapability {
...
mod tests {
    ...
    #[test]
    fn profile_records_reviewed_codex_semantics() {
        let daily = CODEX_PROFILE.daily.unwrap();
