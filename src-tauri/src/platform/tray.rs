...
const OPEN_ID: &str = "burnly.tray.open";
...
mod tests {
    ...
    fn action_ids_map_to_tray_actions() {
        assert_eq!(action_from_id(OPEN_ID), Some(TrayAction::Open));
