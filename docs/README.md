# Burnly Documentation

This directory is the source of truth for Burnly product and engineering decisions.
...
- [Data and ingestion design](./architecture/data-ingestion-design.md)
- [Application architecture](./architecture/application-architecture.md)
- [Project structure](./architecture/project-structure.md)
- [SQLite database and migration design](./architecture/database-design.md)

## Contracts

- [IPC contract design](./contracts/ipc-contract-design.md)
- [Collector adapter contract design](./contracts/collector-adapter-contract-design.md)
...
- [Desktop auth via Burnly Web (desktop handoff)](./planning/desktop-auth-via-web-handoff.md)
