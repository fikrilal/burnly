...
| ------------------------------------------ | ------ | ---------- | ----------------------------------------------------------------- |
| Phase 3A: Collector port and types         | Queued | Phase 2    | [Plan](../queued/2026-06-14_phase-3a-collector-port.md)           |
| Phase 3B: ccusage profile and manifest     | Queued | Phase 3A   | [Plan](../queued/2026-06-14_phase-3b-ccusage-profile.md)          |
| Phase 3C: Sidecar process boundary         | Queued | Phase 3B   | [Plan](../queued/2026-06-14_phase-3c-sidecar-process-boundary.md) |
...
- [ ] Phase 3A completed and verified.
- [ ] Phase 3B completed and verified.
