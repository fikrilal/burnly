...
| Zed          | Planned           | Collected through Burnly's native local collector. Reads agent thread token usage from `~/.local/share/zed/threads/threads.db` (zstd-compressed thread JSON) with per-request history in the Zed telemetry log. Experimental collector in development; source identity and thread store are staged, collector wiring pending.                                                                                                                                                                                                                                                                         |
