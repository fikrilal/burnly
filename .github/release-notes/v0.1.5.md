...
- Adds a one-command macOS preview installer that copies `Burnly.app` to
  `/Applications` and clears quarantine.
...
```bash
curl -fsSL https://github.com/fikrilal/burnly/releases/download/v0.1.5/install-macos.sh | BURNLY_VERSION=v0.1.5 sh
```
