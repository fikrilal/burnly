...
```bash
curl -fsSL https://github.com/fikrilal/burnly/releases/download/v0.1.19/install-linux.sh | BURNLY_VERSION=v0.1.19 sh
```
...
```bash
curl -fsSL https://github.com/fikrilal/burnly/releases/download/v0.1.19/install-macos.sh | BURNLY_VERSION=v0.1.19 sh
```
